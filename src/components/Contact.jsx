  ...
  return (
    <Box id="contact" sx={{ py: { xs: 10, md: 14 }, background: '#FFFFFF', position: 'relative' }}>
      <Container maxWidth="lg">
        ...
        {/* Mapa Decorativo Original */}
        <Box sx={{
          mt: 8, height: '400px', borderRadius: '24px', overflow: 'hidden',
          ...
          <Box sx={{ textAlign: 'center', position: 'relative', zIndex: 1 }}>
            ...
            <Typography sx={{ fontSize: '24px', fontWeight: 700, color: '#424242', mb: 1 }}>Find Us Here</Typography>
            <Typography sx={{ fontSize: '16px', color: '#757575' }}>123 Champion Street, Jacksonville, FL 32202</Typography>
          </Box>
        </Box>
      </Container>
    </Box>
